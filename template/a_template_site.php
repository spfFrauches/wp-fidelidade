    ...
    <section id="">
        <div class="container px-5">
            <div class="row gx-5 align-items-center mb-5">                
                <div class="col-lg-4 order-lg-1 imgDemo">
                    <!-- Features section device mockup-->
                ...
                <div class="col-lg-8 order-lg-0 mb-5 mb-lg-0 propEmpresa">
                    <div class="container-fluid px-5">
                        <div class="row gx-5">
                            <div class="col-md-6 mb-5">
                                <!-- Feature item-->
                            ...
                            <div class="col-md-6 mb-5">
                                ...
                                <div class="text-center">
                                    <i class="bi-camera icon-feature text-gradient d-block mb-3"></i>
                                    <h3 class="font-alt">Marque os clientes</h3>
                                    <p class="text-muted mb-0">
                                        Marcar pontos do cliente no cartão app web.
                                    </p>
                                </div>
                            </div>
                        </div>
